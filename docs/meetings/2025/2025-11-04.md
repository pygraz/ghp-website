...
A look into the updates in the juypter environment.
Time was too short for some; so I mainly demoed Jupyter-AI.
Still, the other extensions are interesting to look into, too.

- [Jupyter GIS](https://jupytergis.readthedocs.io/)
- [Jupyter AI](https://jupyter-ai.readthedocs.io/)
- [Jupyter Text](https://jupytext.readthedocs.io/en/latest/) and [Quarto](https://quarto.org/)
- [yFiles for Jupyter](https://www.yworks.com/products/yfiles-graphs-for-jupyter) - interactive graphs - not mentioned in talk
- [Jupyter Rise](https://pypi.org/project/jupyterlab-rise/) - Slides in Jupyter - not mentioned in talk
...
Using historic data from Spotify and an own category for musical styles, the creative development of musical artists over time can be visualized.

Also of possible interest: [Music map of related artists](https://www.music-map.com/taylor+swift)
...
- `uv add granian` - to install granian
- `uv run --python 3.14t granian --interface asgi --workers 2 main:app --port 9000` - to run the FastAPI application with granian using free-threaded Python 3.14
- `ab -c5 -n20 http://127.0.0.1:9000/` - to benchmark the application with ApacheBench
...
We emphasised the need for the ongoing collection of local club "[Spektral](https://spektral.at)".

They helped us to develop and keep pygraz a free-to-access meeting for everybody.
It is a incubator and home for a variety of interesting groups in Graz.

**UPDATE after the meeting**: the campaign was finished successful: Spektral will continue to exist, congratulations!
